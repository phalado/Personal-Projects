...
Space to post the links to the projects that I'm working in [Microverse][Micro-url]
...
The objective was to create a code that uses the [Bubble Sort method](http://en.wikipedia.org/wiki/Bubble_sort) to sort the elements in an array.
...
The objective was to create a command prompt implementation of the classic Tic-Tac-Toe game, built with the Ruby language.
...
The objective was to create test using RSpec for the Tic-Tac-Toe project.
...
https://github.com/phalado/SQL-Zoo

This project consists in going to [SQL Zoo](http://sqlzoo.net/wiki/Main_Page) and doing the Tutorials from 0 to 9.
...
The objective was to build a simple scaffolded app on Rails.

Live version [here](https://getting-your-feet-wet.herokuapp.com/)
...
The objective was to use [rest-client gem](https://github.com/rest-client/rest-client) to create a [Bing](https://www.bing.com/) search (really? Bing?) and examine the results.
